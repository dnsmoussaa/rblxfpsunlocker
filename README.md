...
À propos des FFlags
Le projet utilise également des FastFlags (FFlags) de Roblox afin de tester différents paramètres pouvant avoir un impact sur les performances et le rendu du jeu.


Avertissement
Roblox peut modifier son fonctionnement ou supprimer la prise en charge de certains paramètres lors de ses mises à jour.
Le fonctionnement du script n'est donc pas garanti après chaque mise à jour de Roblox.
